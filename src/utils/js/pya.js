...
document.querySelector('.list-container').insertAdjacentHTML('afterend', modal)
modal = modals('4', 'CUPRESSUS', '10', '11', '12', 'Posee hojas pequeñas de 2 a 5 milímetros de longitud, color verde oscuro y textura escamosa, que crecen en brotes redondeados. Cuando se aplastan, despiden un agradable aroma.', '>Este género de árboles crece en casi todas las zonas cálidas y templadas del mundo. En Europa tiene un uso ornamental en parques y lugares públicos, mientras que en muchos países de Asia es un típico acompañante de los templos y edificaciones religiosas.', 'Su precio apróximado es COP350,000')
document.querySelector('.list-container').insertAdjacentHTML('afterend', modal)
...
/* INTRODUCIDOS */
modal = modals('13', 'PALMA ACEITERA', '37', '38', '39', 'La palma de aceite es una planta tropical propia de climas cálidos, se desarrolla hasta los 500 metros sobre el nivel del mar. Dentro de los cultivos de semillas oleaginosas es el que produce mayor cantidad de aceite por hectárea. ', 'En el mundo, los principales productores de palma son Indonesia, Malasia, Tailandia, Colombia y Nigeria, países que han tenido un crecimiento exponencial en sus economías.', 'Su precio apróximado es COP756,738')
document.querySelector('.list-container').insertAdjacentHTML('afterend', modal)
modal = modals('14', 'EUCALIPTO', '40', '41', '42', 'El eucalipto es un árbol de gran desarrollo; de corteza de color gris; que alcanza alturas que pueden rebasar los 100 mts. sus hojas son dimorfas, con fuerte olor a cineol; son opuestas en las ramas jóvenes y luego son alternas y pecioladas; de color verde; de 10 a 20 cm. de largo.', 'El eucalipto es una planta que se desarrolla en climas frescos y húmedos. Los fríos excesivos no son aptos para estas plantas, aunque pueden tolerar temperaturas de -3°C hasta -5°C. su hábitat originario es Australia y Tasmania.', 'Su precio apróximado es COP956,666')
document.querySelector('.list-container').insertAdjacentHTML('afterend', modal)
modal = modals('15', 'ELAEIS GUINEENSIS', '43', '44', '45', 'Hierba con tallos subterráneos (rizomas) horizontales, muy aromáticos de sabor picante y color blanco en su interior. Falsos tallos aéreos de entre 60- 90 cm de altura, con hojas alternas lineares de hasta 20 cm de longitud.', 'Es nativa del suroriente asiático, India y China, donde ha sido un componente integral de la dieta y valorado por sus propiedades aromáticas, culinarias y medicinales durante miles de años.', 'Su precio apróximado es COP700,738')
document.querySelector('.list-container').insertAdjacentHTML('afterend', modal)
